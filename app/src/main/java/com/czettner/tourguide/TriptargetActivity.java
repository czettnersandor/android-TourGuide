...
public class TriptargetActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_triptarget);

        int startSection = getIntent().getIntExtra(ARG_SECTION_NUMBER, 1);
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public CharSequence getPageTitle(int position) {
            switch (position) {
                case 0:
                    return getString(R.string.eat_out);
                case 1:
                    return getString(R.string.walk);
                case 2:
                    return getString(R.string.sport);
                case 3:
                    return getString(R.string.annual_events);
            }
            return null;
        }
    }
